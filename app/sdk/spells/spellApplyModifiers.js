...
class SpellApplyModifiers extends Spell {
  ...
  onApplyEffectToBoardTile(board, x, y, sourceAction) {
    ...
    if (entity != null) {
      return Array.from(this.getAppliedTargetModifiersContextObjects()).map((modifierContextObject) => this.getGameSession().applyModifierContextObject(modifierContextObject, entity));
    }
  }
