...
class BeginnerVetruvianChallenge3 extends Challenge {
  ...
  setupBoard(gameSession) {
    ...
    return [0, 1, 2, 3].map((i) => shadowWatcherModifier.applyManagedModifiersFromModifiersContextObjects(shadowWatcherModifier.modifiersContextObjects, shadowWatcher));
  }
