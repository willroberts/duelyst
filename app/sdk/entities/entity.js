...
class Entity extends Card {
  ...
  */
  ...
  actionPropertiesForActionStateRecord() {
    ...
    properties.damage = () => this.getDamage();
    properties.hp = () => this.getHP();
    properties.maxHP = () => this.getMaxHP();
    properties.baseMaxHP = () => this.getBaseMaxHP();
    properties.atk = () => this.getATK();
    properties.baseATK = () => this.getBaseATK();
