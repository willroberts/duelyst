	...
	static cosmeticResourcesForIdentifier(identifier) {
		...
		if (cosmeticData != null) {
			...
			if (cosmeticData.animResource != null) {
				for (let animResourceKey of Array.from(Object.keys(cosmeticData.animResource))) {
...
for (cosmeticTypeKey in CosmeticsLookup) {
	...
	for (let cosmeticKey in cosmeticsOfType) {
...
for (let cosmeticChestTypeKey of Array.from(cosmeticChestTypes)) {
...
for (let cosmeticIdKey in cosmeticIdKeys) {
...
for (let cosForDesc of Array.from(allCosForDesc)) {
...
for (let cosForOrder of Array.from(allCosForRewardOrder)) {
