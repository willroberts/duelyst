...
router.delete('/inventory/unused', function(req, res, next) {
    ...
    .then(function(cardCollectionRow) {
        ...
        for (let cardId in cardCollectionRow.cards) {
...
router.post('/daily_challenge', function(req,res,next){
	...
	.then(function(gzipGameSessionData) {
		...
		return s3.putObjectAsync(params);}).then(() => DuelystFirebase.connect().getRootRef()).then(function(fbRootRef) {
