...
`,
        ...
        .then(function (result) {
          if (result != null) {
            ...
            return Promise.map(this.gamesData, (gameRow) => {
              ...
              return new Promise((resolve, reject) => request.get(gameDataUrl).end((err, res) => {
