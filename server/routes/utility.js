...
router.post("/utility/client_logs", function(req, res, next) {
	...
	return loadClientLogsHandlebarsTemplateAsync.then(function(template) {
		...
		return res.status(200).json({ logs_url: url });}).catch(function(err) {
