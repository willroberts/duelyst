...
router.get("/forgot/:reset_token", function(req, res, next) {
	...
	.then(function(resetTokenData) {
		...
		return knex('users').where('id',resetTokenData.user_id).first();}).then(function(userData) {
...
router.post("/forgot/:reset_token", function(req, res, next) {
